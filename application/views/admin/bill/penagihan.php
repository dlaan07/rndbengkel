    ...
    <div class="col-md-7 col-sm-12">
        <div class="card card-info elevation-5">
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6>Data Penagihan</h6>
                        <hr>
                        <form action="<?= base_url('Admin/Bill/simpanPenagihan') ?>" method="POST">
                            <input type="text" name="idorder" value="<?= $bill['bill_id'] ?>" hidden>

                            <input type="text" name="order" value="<?= $order['order_id'] ?>" hidden>

                            <input type="text" name="email" value="<?= $order['pelanggan_email'] ?>" hidden>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Total Harga Jasa</label>
                                <input type="text" name="jasa" class="form-control" value="<?= $order['order_totalJasaHarga'] ?>" hidden>
                                <input type="text" class="form-control" value="<?= number_format($order['order_totalJasaHarga'], 0, "", ".") ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Total Harga Part</label>
                                <input type="text" class="form-control" name="parts" value="<?= $total ?>" hidden>
                                <input type="text" class="form-control" value="<?= number_format($total, 0, "", ".") ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Total Biaya</label>
                                <input type="text" class="form-control" name="total" value="<?= $total + $order['order_totalJasaHarga'] ?>" hidden>
                                <input type="text" class="form-control" value="<?= number_format($total + $order['order_totalJasaHarga'], 0, "", ".") ?>" readonly>
                            </div>
                            <div class="form-group">
