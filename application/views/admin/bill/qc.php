    ...
    <div class="col-md-7 col-sm-12">
        <div class="card card-info elevation-5">
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6>Form Test Drive</h6>
                        <hr>
                        <form action="<?= base_url('Admin/Bill/simpanQc') ?>" method="POST">
                            <input type="text" name="idorder" value="<?= $bill['bill_id'] ?>" hidden>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Hasil Test Drive</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="Ok" name="qc" onchange="showDiv(this)">
                                    <label class="form-check-label">OK</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="Service Ulang" name="qc" onchange="showDiv(this)">
                                    <label class="form-check-label">Service Ulang</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="catatan" style="display:none">
                                ...
                                <textarea class="form-control" name="ket" placeholder="Catatan"></textarea>
                            </div>
                            <div class="form-group">
