  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: linear-gradient(to top, #000000 70%, #0085ff 100%);">
      <!-- Brand Logo -->
      <a href="<?= base_url('Gudang/Dashboard') ?>" class="brand-link text-center">
          ...
          <span class="brand-text font-weight-bold">HI Gudang !</span><br>
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('Gudang/Parts') ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('Gudang/Rfp') ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('Gudang/Purchaseorder') ?>" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url('Gudang/Tracking') ?>" class="nav-link">
