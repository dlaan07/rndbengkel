        ...
        <div class="card card-info elevation-5">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    <a href='http://kampung14bjs.com/Validasi/validasiSetuju?token="<?= $order['id_order'] ?>"'><button> SETUJU </button></a><br><br>
                    <a href='http://kampung14bjs.com/Validasi/validasiCancel?token="<?= $order['id_order'] ?>"'><button> Tidak SETUJU </button></a><br>

                    <!-- <div class="p-0"> -->
                    <!-- <form action="<?= base_url('Admin/Validasi/validasiSetuju') ?>" method="POST">
                        <input type="text" name="idorder" value="<?= $order['order_id']; ?>" hidden>
                        <input type="text" name="setuju" value="5" hidden>
                        <button type="submit" class="btn btn-primary">Setuju</button>
                    </form> -->
                    <!-- </div> -->
                    <!-- <div class="p-0"> -->
                    <!-- <form action="<?= base_url('Admin/Validasi/validasiCancel') ?>" method="POST">
                        <input type="text" name="idorder" value="<?= $order['order_id']; ?>" hidden>
                        <input type="text" name="tdksetuju" value="6" hidden>
                        <button type="submit" class="btn btn-warning">Tidak Setuju</button>
                    </form> -->
                    <!-- </div> -->
                </div>
            </div>
