...
<?php
foreach ($admin as $b) { ?>
    <form action="<?= base_url('Owner/Konfigurasi/edit_admin') ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-8">
                                        <input class="form-control" name="tlp" type="text" value="<?= $b['user_telp'];
                                                                                                    ?>"  maxlength="12" onkeypress="return Angkasaja(event)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label">Role</label>
                                    <div class="col-sm-12 col-md-8">
                                        <select class="form-control" name="role" style="width: 100%;">
                                            <?php
                                            foreach ($role as $r) { ?>
                                                <option value="<?= $r['role_id'] ?>" <?php if ($r['role_id'] == $b['user_role']) {
                                                                                            echo "selected";
                                                                                        } ?>>
                                                    <?= $r['role_nama'] ?>
                                                </option>
...
<?php
foreach ($admin as $b) { ?>
    <form action="<?= base_url('Owner/Konfigurasi/hapus_admin') ?>" method="POST">
...
<!-- Tambah Admin -->
<form action="<?= base_url('Owner/Konfigurasi/tambah_admin') ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-30">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">Telepon/Hp</label>
                                <div class="col-sm-12 col-md-8">
                                    <input class="form-control" name="tlp" type="text" placeholder="No. Telpon/Hp"  maxlength="12" onkeypress="return Angkasaja(event)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">Password</label>
