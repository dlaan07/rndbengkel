                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?= number_format($bill['bill_parts'], 0, "", ".") ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Total Biaya</label>
                            <input type="text" class="form-control" value="<?= number_format($bill['bill_parts'] + $order['order_totalJasaHarga'], 0, "", ".") ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
