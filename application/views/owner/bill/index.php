        ...
        <div class="table-responsive">
            <table id="example1" class="table table-striped">
                ...
                <tbody>
                    <?php
                    $no = 0;
                    foreach ($order as $data) { //$order di ambil dari controller owner nama file order nama function index
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('Owner/Bill/penagihan/') . $data['order_id'] ?>" class="btn btn-warning btn-sm text-bold">
