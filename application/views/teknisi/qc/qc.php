    ...
    <div class="col-md-7 col-sm-12">
        <div class="card card-info elevation-5">
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6>Form Perbaikan Ulang</h6>
                        <hr>
                        <form action="<?= base_url('Teknisi/PerbaikanUlang/simpanQc') ?>" method="POST">
                            <input type="text" name="idorder" value="<?= $bill['bill_id'] ?>" hidden>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Hasil Perbaikan Ulang</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="PU Selesai" name="qc">
                                    <label class="form-check-label">PU Selesai</label>
                                </div>
                                <!--<div class="form-check">-->
                                <!--    <input class="form-check-input" type="radio" value="Service" name="qc">-->
